...
const (
	panelUpdaterURL      = "https://raw.githubusercontent.com/ndotvpn/3x-ui/main/update.sh"
...
func fetchLatestPanelVersion() (string, error) {
	...
	resp, err := client.Get("https://api.github.com/repos/ndotvpn/3x-ui/releases/latest")
	if err != nil {
		return "", err
	}
	defer resp.Body.Close()
